...
<body>
    <div class="container">
        ...
        <ul>
            <li><strong>/api?token=X</strong> - Returns full JSON object with live token data, deriving max and ciculating supply.</li>
            <li><strong>/api/max?token=X</strong> - Returns plain text of the max supply, normalized by given decimal precision.</li>
            <li><strong>/api/circulating?token=X</strong> - Returns plain text of the max supply subtracted by the pre-minted supply, normalized by given decimal precision.</li>
        </ul>
